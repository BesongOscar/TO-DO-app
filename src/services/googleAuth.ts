/**
 * googleAuth - Google Sign-In service using native SDK
 * 
 * Wraps @react-native-google-signin with typed result interface.
 * Handles Play Services checks, sign-in flow, sign-out, and error messaging.
 */
