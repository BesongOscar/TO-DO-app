/**
 * useTaskNotifications - Hook for syncing task reminders with local notifications
 * 
 * Schedules/cancels expo-notifications when tasks are loaded, toggled, updated, or deleted.
 * Handles monthly repeat refill logic for repeated reminders.
 */
